...
1. activate the ttpa_psychopy environment that has all libraries necessary to run the code:

conda activate ttpa_psychopy

2. Navigate to the folder where the script is:

C:\Users\lukib862\Documents\ttpa_touch_the_pain_away\Python

3. Use the right python command file:

python stim_from_file_with_interrupt.py 
